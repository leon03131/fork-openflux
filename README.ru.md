...
1. **yandex** — пакеты через курсорные сообщения Yandex Docs;
2. **oneme** — пакеты, замаскированные под WebRTC ICE-кандидаты, через сигналинг звонков MAX;
3. **direct** — эталонный TCP carrier (локальное тестирование/отладка).
