...
|---|---|---|
| **direct** | ✅ stable | Plain TCP; fastest; exit needs an open port |
| **onlyoffice** | ✅ live-validated | Current Yandex Docs (OnlyOffice editor), public doc link with edit rights |
| **mail** | ✅ live-validated | Mail.ru Cloud documents (R7-Office), public link with edit rights |
| **oneme** | 🧪 experimental | MAX messenger call signaling (ICE-candidate injection) |
| **yandex** | ⚠️ deprecated | Legacy Yandex Docs editor — provider migrated away |
